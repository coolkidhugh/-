...
.result-shell { margin-top: 1.1rem; animation: rise 0.55s ease-out both; }
...
def inject_page_styles(css: str) -> None:
    """Inject fonts + CSS into the parent Streamlit document."""
    # Escape backticks/backslashes for JS template literal safety.
    ...
    components.html(
        ...
        (function () {{
          ...
          if (!doc.getElementById("bojue-font-link")) {{
            const link = doc.createElement("link");
            link.id = "bojue-font-link";
            link.rel = "stylesheet";
            link.href = "https://fonts.googleapis.com/css2?family=Noto+Sans+SC:wght@400;500;600;700&family=Noto+Serif+SC:wght@500;600;700&display=swap";
            doc.head.appendChild(link);
          }}
          let style = doc.getElementById("bojue-page-style");
          if (!style) {{
            style = doc.createElement("style");
            style.id = "bojue-page-style";
